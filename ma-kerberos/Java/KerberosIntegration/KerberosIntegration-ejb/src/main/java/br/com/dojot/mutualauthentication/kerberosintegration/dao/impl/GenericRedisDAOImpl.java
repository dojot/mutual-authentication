...
public class GenericRedisDAOImpl {
	...
	public void init() {
        ...
        pool = new JedisSentinelPool(KerberosIntegrationConstants.REDIS_CLUSTER_MASTER_NAME, sentinels, poolConfig);
	...
	private void getNewConnection() {
		...
		try {
			...
			loggingService.saveLogging(Level.ERROR, "KERBEROS_INTEGRATION", "SISTEMA", "Falha na obtencao de uma conexao com o redis-node master");
		}
    }
	...
	public String get(String key) {
		...
		try {
			...
			loggingService.saveLogging(Level.ERROR, "KERBEROS_INTEGRATION", "SISTEMA", getClass().getName() + ":" + e.getMessage());
			getNewConnection();
		}
		return content;
	}

...
@Startup
@Singleton
public class ComponentsProducerServiceImpl extends Thread implements ComponentsProducerService {
	...
	public void init() {
		...
		producer = new ProducerServiceImpl(configDAO.findConfigurationByKey(KerberosIntegrationConstants.PARAM_KAFKA_BOOTSTRAP_SERVERS),
				KerberosIntegrationConstants.TOPIC_NUMBER_COMPONENTS,
				(String) facade.requestNodeConfigs().get(CommunicationKeysConstants.KEY_VERSION), "ker.components.");
	}
	...
	@Override
	public void produce(BatchNumberComponentsDTO dto) {

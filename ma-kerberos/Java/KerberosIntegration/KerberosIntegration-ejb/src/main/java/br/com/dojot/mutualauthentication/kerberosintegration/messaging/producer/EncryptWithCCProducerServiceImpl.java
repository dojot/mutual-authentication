...
@Startup
@Singleton
public class EncryptWithCCProducerServiceImpl extends Thread implements EncryptWithCCProducerService {
	...
	public void init() {
		...
		producer = new ProducerServiceImpl(configDAO.findConfigurationByKey(KerberosIntegrationConstants.PARAM_KAFKA_BOOTSTRAP_SERVERS),
				KerberosIntegrationConstants.TOPIC_ENCRYPT_WITH_CC,
				(String) facade.requestNodeConfigs().get(CommunicationKeysConstants.KEY_VERSION), "ker.encryptcc.");
	}
